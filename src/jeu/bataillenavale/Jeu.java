...
public class Jeu {
	 ...
	 * @param args contient les noms de chacun des joueurs. Si un des noms ou les deux manque, un nom par defaut est attribue
	 */
	public Jeu(String[] args) {
		if (args.length > 0) // 1 ou 2
			joueur1 = new Joueur(args[0]);
		else {
			joueur1 = new Joueur("Anass");
			joueur1.setJeu(this);
		}
	 ...
	 * Entre au clavier 'h' ou 'v'
	 * @return un booleen qui a pour valeur
	 * 		<i>true</i>  : orientation horizontale
	 * 		<i>false</i> : orientation verticale
	 */
